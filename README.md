This repository holds code for various projects that I've worked on both in school and on my own time. It should be noted that some files must be downloaded to be viewed properly. Also, the names and personal information shown are generated data. No actual people and data are referenced in this repository. Lastly, all of the code for importing and exporting data and files was modified to remove the file paths used on my computer, though these file paths are still visible in some images, code outputs, and Colab notebook warnings.
